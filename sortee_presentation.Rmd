...
<div class="notes">
Computational reproducibility refers to the ability to produce equivalent analytical outcomes from the same data set using the same code and software as the original study. 
</div>
...
## ResearchOps Framework {data-transition="fade-out"}
...
<div class="notes">
Ideally to have this at the onset of a project would be nice however, going through this process can also be beneficial during a project. This can also be adopted by a single researcher and scaled to larger collaborative research projects. 
</div>
